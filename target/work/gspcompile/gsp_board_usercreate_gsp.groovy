...
class gsp_board_usercreate_gsp extends GroovyPage {
...
invokeTag('eachError','g',19,['bean':(userInstance),'var':("error")],3)
printHtmlPart(15)
})
invokeTag('hasErrors','g',21,['bean':(userInstance)],2)
printHtmlPart(8)
createTagBody(2, {->
printHtmlPart(16)
...
invokeTag('form','g',29,['url':([resource:userInstance, action:'register'])],2)
printHtmlPart(19)
})
...
public static final long LAST_MODIFIED = 1500027541256L
